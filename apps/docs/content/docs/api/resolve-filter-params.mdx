...
<Callout>
  ...
  [`valueType`](/docs/filter-types/async#value-types) — the loader has no options to infer from, and
  without it the loader and hook can parse the URL to different types. Dev builds warn when this
  happens.
</Callout>
